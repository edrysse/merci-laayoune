...
<nav class="navbar navbar-expand-lg bg-body-tertiary" style="background-color:bisque !important">
    <div class="container">
        <a class="navbar-brand" href="{{ secure_url(route('admin')) }}">admin</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="{{ secure_url('repas') }}">menu</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ secure_url('contact') }}">contact</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ secure_url('reservation') }}">reservation</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ secure_url('photos') }}">gallery</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ secure_url('user') }}">users</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ secure_url('blog') }}">blogs</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ secure_url('chef') }}">chefs</a>
                </li>
            </ul>
        </div>
    </div>
